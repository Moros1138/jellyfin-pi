...
void update()
{
    ...
    DrawStringDropShadow(app.renderer, app.font, 5*app.screenScale, 160*app.screenScale, "Mouse Pos: (" + std::to_string(mouse_x) + ", " + std::to_string(mouse_y) + ")",
                            Color(255, 255, 255), Color(0, 0, 0));
...
int main()
{
    ...
    pgetinker_file_resolve("https://raw.githubusercontent.com/qwerasd205/PixelCode/main/dist/ttf/PixelCode.ttf", "assets/gfx/PixelCode.ttf");
    app.font = TTF_OpenFont("assets/gfx/PixelCode.ttf", 8 * app.screenScale); // Replace with a valid font path
    if(!app.font)
    {
